...
const Resume = forwardRef((props, ref) => {
  ...
  const colors = ["rgb(7, 7, 85)", "#000000", "#0c3bd5","#2f4797"];
    ...
    [sections.workExp]: ( 
      ...
      > 
        ...
        <div className={styles.content}>
          ...
          {info.workExp?.details?.map((item,i) => (
  ...
  useEffect(() => {
    setColumns([
      ...
      [sections.workExp, sections.achievement,sections.skills, sections.other],
    ]);
  }, []);
  ...
  useEffect(() => {
    ...
    container.style.setProperty("--textColor", activeColor);
  }, [activeColor]);

  // If variables are in :root file:
  // useEffect(() => {
  //   document.documentElement.style.setProperty('--textColor', activeColor);
  // }, [activeColor]);
  return (<>
    <div className={styles.colors}>
     <span className={styles.font}>Font Color :</span> 
    {colors.map((item) => (
      <span
        key={item}
